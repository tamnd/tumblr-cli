...
Most of these come down to network reality or how tumblr serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

tumblr rate-limits like any public site. tumblr already paces
...
Where a surface is gated, tumblr reads a cookie or token you supply
...
`tumblr`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what tumblr actually did
